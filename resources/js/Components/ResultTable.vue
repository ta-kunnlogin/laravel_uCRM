...
<template>
    ...
    <div v-if="data.type === 'rfm'" class="lg:w-2/3 w-full mx-auto overflow-auto">
        <h2 class="text-center my-4">RFM 分析結果</h2>
        ...
        <table class="table-auto w-full text-left whitespace-no-wrap">
            ...
            <tbody>
                <tr v-for="rfm in data.eachCount" :key="rfm.data">
        ...
        <table class="table-auto w-full text-left whitespace-no-wrap">
            ...
            <tbody>
                <tr v-for="rfm in data.data" :key="rfm.rRank">
                    <td class="border-b-2 border-gray-200 px-4 py-3">{{ rfm.rRank }}</td>
                    <td class="border-b-2 border-gray-200 px-4 py-3">{{ rfm.f_5 }}</td>
                    <td class="border-b-2 border-gray-200 px-4 py-3">{{ rfm.f_4 }}</td>
                    <td class="border-b-2 border-gray-200 px-4 py-3">{{ rfm.f_3 }}</td>
                    <td class="border-b-2 border-gray-200 px-4 py-3">{{ rfm.f_2 }}</td>
                    <td class="border-b-2 border-gray-200 px-4 py-3">{{ rfm.f_1 }}</td>
                </tr>
            </tbody>
        </table>
    </div>
